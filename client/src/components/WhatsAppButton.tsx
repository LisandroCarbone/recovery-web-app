...
const WhatsAppButton = () => {
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg shadow-green-500/20 hover:shadow-green-500/40 transition-shadow flex items-center justify-center group"
