...
const Hero = () => {
    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
            {/* Background with Gradient Mesh & Watermark */}
            <div className="absolute inset-0 z-0 bg-background flex items-center justify-center overflow-hidden">
                ...
                <motion.img
                    ...
                    style={{ maskImage: 'radial-gradient(circle, black 50%, transparent 90%)', WebkitMaskImage: 'radial-gradient(circle, black 50%, transparent 90%)' }}
                />
            </div>
